...
import com.LMS.pageObjects.UserInputFieldFunctionality;
import com.LMS.utilities.ReadConfig;

import io.cucumber.java.en.Then;
import io.cucumber.java.en.When;

public class UserInputField extends BaseClass {

	ReadConfig config = new ReadConfig();
	String baseurl = config.getApplicationURL();
	UserInputFieldFunctionality inputField = new UserInputFieldFunctionality(driver);

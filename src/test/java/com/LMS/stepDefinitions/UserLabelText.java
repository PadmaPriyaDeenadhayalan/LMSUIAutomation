...
import com.LMS.pageObjects.UserLabelTextFunctionality;
import com.LMS.utilities.ReadConfig;

import io.cucumber.java.en.Then;

public class UserLabelText extends BaseClass{

	ReadConfig config=new ReadConfig();
	String baseurl=config.getApplicationURL();
	UserLabelTextFunctionality labelText = new UserLabelTextFunctionality(driver);

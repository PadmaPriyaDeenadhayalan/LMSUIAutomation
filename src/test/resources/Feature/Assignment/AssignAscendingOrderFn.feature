...
@tag
Feature: Assignment Page Ascending order Functionality
Background: Admin/User/Staff Logged on to LMS Website for Assignment Page
  
   @tag1
  Scenario:   Verify Assignment Names are displayed in Ascending order
  ...
  @tag2
  Scenario: Verify Assignment Descriptions are displayed in Ascending order
  Given  Admin/User/Staff is on Manage Assignment page
  ...
  Then  Admin/User/Staff view the Assignment Duedates are displayed in Ascending order
   ...
   @tag4
  Scenario: Verify Assignment Grades are displayed in Ascending order
  Given  Admin/User/Staff is on Manage Assignment page
